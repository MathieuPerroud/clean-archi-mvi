...
import com.bookandgo.common.extensions.createViewModelLazy
...
abstract class MVIFragment<State, Intent, Binding : ViewDataBinding, VM: StateIntentViewModel<State,Intent>>(
    ...
    private val viewModelClass =  parameterizedType.actualTypeArguments.last() as Class<VM>
    //Hilt doesn't permit getting the genericSuperClass; thanks to generated classes we have to parameter
    //the viewmodels class
    */

    val viewModel by createViewModelLazy(viewModelClass, { viewModelStore })
